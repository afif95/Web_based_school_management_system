...
$sql = "INSERT INTO student(roll,school_class,first_name,middle_name,last_name,father_name,mother_name,sex,email,dob,password,security_question,security_ans) 
